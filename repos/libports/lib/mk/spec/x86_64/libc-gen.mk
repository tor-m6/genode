...
# do not use freebsd libc context function
FILTER_OUT_C += _set_tp.c getcontextx.c signalcontext.c
...
# add files for context switch
SRC_S += __start_context.S  getcontext.S  setcontext.S  swapcontext.S
